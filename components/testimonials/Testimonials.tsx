      ...
      <div className="container">
        ...
        >
          {testimonials.map((test) => (
            <SwiperSlide className={styles["testimonial"]} key={test.id}>
              <div className={styles["client__avatar"]}>
                <a href={test.link}>
                  <BsLinkedin />
                </a>
              </div>
              <h5 className={styles["client__name"]}>{test.name}</h5>
              <small className={styles["client__review"]}>{test.test}</small>
            </SwiperSlide>
          ))}
        </Swiper>
      </div>
